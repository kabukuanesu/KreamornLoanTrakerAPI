        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProofOfIdentity = table.Column<byte[]>(type: "varbinary(MAX)", nullable: true),
                    ProofOfResidence = table.Column<byte[]>(type: "varbinary(MAX)", nullable: true),
                    BankStatement = table.Column<byte[]>(type: "varbinary(MAX)", nullable: true),
                    ProofOfIncome = table.Column<byte[]>(type: "varbinary(MAX)", nullable: true),
                    BenefitDocument = table.Column<byte[]>(type: "varbinary(MAX)", nullable: true),
                    EmploymentVerification = table.Column<byte[]>(type: "varbinary(MAX)", nullable: true),
                    CollateralDocument = table.Column<byte[]>(type: "varbinary(MAX)", nullable: true),
                    OtherDocument = table.Column<byte[]>(type: "varbinary(MAX)", nullable: true),
